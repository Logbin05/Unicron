...
pub mod auth_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn register(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("users.AuthService", "Register"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn login(
            &mut self,
            request: impl tonic::IntoRequest<super::LoginReq>,
        ) -> std::result::Result<tonic::Response<super::LoginRes>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/users.AuthService/Login");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("users.AuthService", "Login"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod auth_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/users.AuthService/Register" => {
                    ...
                    impl<T: AuthService> tonic::server::UnaryService<super::RegisterReq>
                    for RegisterSvc<T> {
                ...
                "/users.AuthService/Login" => {
                    #[allow(non_camel_case_types)]
                    struct LoginSvc<T: AuthService>(pub Arc<T>);
                    impl<T: AuthService> tonic::server::UnaryService<super::LoginReq>
                    for LoginSvc<T> {
    ...
    pub const SERVICE_NAME: &str = "users.AuthService";
